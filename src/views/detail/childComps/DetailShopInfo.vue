  ...
  <div class="shop-info">
    ...
    <div class="shop-middle">
      <div class="shop-middle-item shop-middle-left" >
        <div class="info-sell">
          <div class="sell-count">{{shop.cSells | sellCountFilter}}</div>
          <div class="sell-text">总销量</div>
        </div>
        <div class="info-goods">
          <div class="goods-count">{{shop.cGoods}}</div>
          <div class="goods-text"><a :href="shop.allGoodsUrl">全部宝贝</a></div>
        </div>
      </div>
    ...
    <div class="shop-bottom">
      <div class="enter-shop"><a :href="shop.shopUrl">进店逛逛</a></div>
    </div>
  </div>
